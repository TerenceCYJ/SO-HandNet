...
parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints/all/semi_v2.1_0.25_1', help='models are saved here')
...
parser.add_argument('--pretrain_encoder', type=str, default='checkpoints/all/semi_v2.1_0.25_1/0_13.941856_0.00000250_net_encoder.pth',
                         help='pre-trained encoder dict path: None or str')
parser.add_argument('--pretrain_decoder', type=str, default='checkpoints/all/semi_v2.1_0.25_1/0_0.003842_0.000250_net_decoder.pth',
                         help='pre-trained decoder dict path: None or str')
parser.add_argument('--pretrain_estimater', type=str, default='checkpoints/all/semi_v2.1_0.25_1/0_13.941856_0.00000250_net_estimater.pth',
