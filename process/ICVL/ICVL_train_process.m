...
save_dir = 'F:\DeepLearningDataset\ICVL\old\Training\process_data\';
...
for index = 1:indexs
    ...
    txt_dir=[dataset_dir subject_names{index} '.txt'];
...
%         scatter3(jnt_xyz_normalized(:,1), jnt_xyz_normalized(:,3), jnt_xyz_normalized(:,2), 50, jnt_colors, 'Fill','LineWidth', 0.5);
    ...
    %% save files
    save_k_dir=[save_dir  subject_names{index}];
    save([save_k_dir '_Point_Cloud.mat'],'Point_Cloud_FPS');
    save([save_k_dir '_Volume_rotate.mat'],'Volume_rotate');
    save([save_k_dir '_Volume_length.mat'],'Volume_length');
    save([save_k_dir '_Volume_offset.mat'],'Volume_offset');
    save([save_k_dir '_Volume_GT_XYZ.mat'],'Volume_GT_XYZ');
